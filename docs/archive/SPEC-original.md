> ARCHIVED 2026-06-10 — original build spec, superseded as live instructions by the new root CLAUDE.md.
> Its **ANNEXE — Partie 2 (SEED exact)** remains the authoritative source for seed VALUES (supabase/seed.sql).
