...
/**
 * Loop 51 (follow-up to P97 / Loop 50) â€” Google Calendar channel
 * renewal cron.
 *
 ...
 * falls back to 60s polling â€” silent UX degradation. This cron
 * scans daily for channels approaching expiry and rotates them.
 *
 * Scheduling (vercel.json):
 *   - Runs daily at 02:30 UTC (â‰ˆ 9:30pm Montreal in winter, well
 ...
 * cron mid-rotation results in another rotation â€” the second run's
...
async function runGoogleChannelRenewCron(): Promise<NextResponse> {
  ...
  // Serial loop â€” each rotation is two Google API calls (~500ms
